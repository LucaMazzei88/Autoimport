...
public class SynchStrategy extends ImportStrategy {
	...
	public void execute() throws Exception {
		...
		dr.click(By.linkText("Catalogs"), "Catalogs", true);
		dr.click(By.linkText("Fastweb Master Catalog"), "Fastweb Master Catalog", true);
		url2=dr.getUrl();
		...
		dr.click(By.name("j_id0:j_id25:preview:j_id33:j_id34"), "j_id0:j_id25:preview:j_id33:j_id34", true); //spunta beta
	//	dr.selectPickList(By.name("j_id0:j_id25:preview:j_id38"), "Naviga Mobile 2GB, Version: 1"); //se commentata fa la synch di tutte le regole
		dr.click(By.id("j_id0:j_id25:preview:j_id26:bottom:j_id30"), "j_id0:j_id25:preview:j_id26:bottom:j_id30", true); //recreate programm
		...
		dr.click(By.id("j_id0:j_id25:preview:j_id26:bottom:j_id27"), "j_id0:j_id25:preview:j_id26:bottom:j_id27", true);
		...
		dr.click(By.id("j_id0:j_id25:preview:j_id26:bottom:j_id29"), "j_id0:j_id25:preview:j_id26:bottom:j_id29", true);
		if(!(temp=dr.closeAlertAndGetItsText()).equals("The action synchronizes Salesforce data with the engine, are you sure?")){
			throw new wrongPopUpException(temp);
		}
		...
		dr.click(By.xpath("//button[@onclick='synchAllRows();return false;']"), "<div class=\"hideArea\" id=\"overlay\">", true);
		if(!(temp=dr.closeAlertAndGetItsText()).equals("The action synchronizes Salesforce data with the engine, are you sure?")){
			throw new wrongPopUpException(temp);
		}
